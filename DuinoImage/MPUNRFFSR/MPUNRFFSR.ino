...
#define fsrAnalogPin1 1
#define fsrAnalogPin2 3
#define threshold 100

float fsrReading1 = 0.0f;
float fsrReading2 = 0.0f;
...
void setup()
{
  ...
  Serial.begin(115200);
  initTransmitterRadio(); // Initialize NRF
  myinit();               // Initialize MPU
}

void loop()
{
  getReadings(); // Reads from MPU
  radio.stopListening();
  PLoad.type = 1;
  PLoad.x = roll;
  PLoad.y = pitch;
  radio.write(&PLoad, sizeof(Payload)); // Sends Payload
